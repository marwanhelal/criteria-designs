  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert(error.error || 'Failed to create award')
      }
    } catch (error) {
    ...
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="text" value={form.titleEn} onChange={(e) => setForm({ ...form, titleEn: e.target.value })} className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500" placeholder="e.g. Pritzker Architecture Prize" required />
            </div>
            <div>
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <p className="text-sm text-gray-500">Shown as the first image and in the admin list.</p>
