...
export default function NewProjectPage() {
  ...
  const [finalRevealImages, setFinalRevealImages] = useState<{ url: string; alt?: string }[]>([])
  ...
  const handleTitleChange = (value: string) => {
    setForm({ ...form, titleEn: value, slug: generateSlug(value) })
  }
    ...
    try {
      const res = await fetch('/api/projects', {
        ...
        body: JSON.stringify({
          ...form,
          images: allImages,
          timeline: timeline.filter(t => t.titleEn.trim())
        })
      })
        ...
        <div className="bg-white rounded-lg shadow p-6 space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="number" value={form.yearCompleted} onChange={(e) => setForm({ ...form, yearCompleted: e.target.value })}
