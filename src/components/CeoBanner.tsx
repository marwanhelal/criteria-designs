        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left">
            ...
            <motion.span
              ...
              className="hidden lg:inline-block font-[var(--font-libre-franklin)] text-[11px] text-[#B1A490] uppercase tracking-[4px] mb-4"
            >
              Our Founder
            </motion.span>
            ...
            {data.ceoTitleEn && (
              ...
              >
                ...
                />
                <p className="font-[var(--font-libre-franklin)] text-[14px] lg:text-[17px] text-white/40 uppercase tracking-[3px]">
                  {data.ceoTitleEn}
                </p>
              </motion.div>
            )}
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-0">
                  {stats.map((stat, i) => (
                    <motion.div
                      ...
                      className={`group/stat flex flex-col px-5 lg:px-8 py-3 cursor-default rounded-md transition-colors duration-300 hover:bg-white/[0.03] ${
                    ...
                    >
                      ...
                      <span className="font-[var(--font-libre-franklin)] text-[10px] lg:text-[12px] text-white/40 uppercase tracking-[2px] mt-2 transition-colors duration-300 group-hover/stat:text-white/60">
                        {stat.label}
                      </span>
                      {'desc' in stat && stat.desc && (
                        <span className="font-[var(--font-open-sans)] text-[11px] text-white/25 mt-1 max-w-[160px] italic leading-[1.4]">
                          {stat.desc}
                        </span>
                      )}
                    </motion.div>
            ...
            >
              {data.ceoBtnTextEn && data.ceoBtnLink && (
                <Link
                  ...
                  className="group/btn relative inline-flex items-center font-[var(--font-libre-franklin)] text-[12px] text-white uppercase tracking-[3px] border border-white/20 px-[36px] py-[14px] overflow-hidden transition-all duration-500 hover:text-[#111] hover:border-white"
                >
                ...
                <div className="flex items-center gap-5 lg:gap-6 lg:ml-4">
                  ...
                  {logos.map((logo, i) => (
                    <motion.div
                      ...
                      className="relative w-[50px] h-[35px] lg:w-[70px] lg:h-[45px] opacity-30 hover:opacity-90 transition-all duration-300 hover:scale-110"
                    >
                      <Image
                        src={logo}
                        alt={`Partner ${i + 1}`}
